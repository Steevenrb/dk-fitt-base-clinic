...
const mealPlan: Record<string, { comida: string; descripcion: string; kcal: number }[]> = {
  Lunes: [
    { comida: "Desayuno", descripcion: "Avena con frutos rojos, semillas de chía y leche de almendra", kcal: 320 },
    { comida: "Colación AM", descripcion: "Manzana verde con 15g de almendras", kcal: 150 },
    { comida: "Comida", descripcion: "Pechuga de pollo a la plancha, arroz integral y ensalada mixta", kcal: 520 },
    { comida: "Colación PM", descripcion: "Yogur griego natural con pepino", kcal: 120 },
  ...
  Martes: [
    ...
    { comida: "Colación AM", descripcion: "Pera con queso cottage", kcal: 140 },
    { comida: "Comida", descripcion: "Salmón al horno con quinoa y espárragos", kcal: 560 },
    { comida: "Colación PM", descripcion: "Jícama con limón y chile", kcal: 80 },
    { comida: "Cena", descripcion: "Ensalada de atún con aguacate y vegetales", kcal: 400 },
  ],
  Miércoles: [
    { comida: "Desayuno", descripcion: "Licuado de proteína con plátano y espinaca", kcal: 310 },
    { comida: "Colación AM", descripcion: "Mix de nueces (20g)", kcal: 160 },
    { comida: "Comida", descripcion: "Filete de res magro con camote y brócoli", kcal: 540 },
    { comida: "Colación PM", descripcion: "Apio con hummus", kcal: 100 },
  ...
  Jueves: [
    ...
    { comida: "Colación AM", descripcion: "Naranja y 10 almendras", kcal: 140 },
    { comida: "Comida", descripcion: "Pollo en salsa verde con nopales y frijoles", kcal: 500 },
    { comida: "Colación PM", descripcion: "Gelatina sin azúcar con fruta", kcal: 70 },
  ...
  Viernes: [
    ...
    { comida: "Colación AM", descripcion: "Piña con requesón", kcal: 130 },
    { comida: "Comida", descripcion: "Tilapia empapelada con verduras y arroz", kcal: 480 },
    { comida: "Colación PM", descripcion: "Pepino con limón", kcal: 40 },
    { comida: "Cena", descripcion: "Ensalada mediterránea con garbanzos", kcal: 370 },
  ],
};
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-4 text-xs text-muted-foreground">
              ...
              <span>Meta calórica: 1,750 kcal/día</span>
              <span>Proteína: 30% · Carbohidratos: 45% · Grasas: 25%</span>
            </div>
          </div>
